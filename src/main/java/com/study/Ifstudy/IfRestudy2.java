...
public static void main(String[] args) {
    ...
    Scanner scanner = new Scanner(System.in); // 시간을 입력하기 위함.
    ...
    if(hour<=24) { // (0 ≤ H ≤ 23 23시 까지의 조건을 입력
        if(minite >= 0 && minite <= 60) { //  0 ≤ M ≤ 59)  까지의 조건을 입력
            if(minite < 45) { // 45분을 앞선다면....
                hour--; // 45분씩 차감 되므로 시의 시간이 줄어듬.
                minite = (minite + 60)-45; //원래 시간보다 45분을 앞서도록 설정.
                ...
                System.out.println(hour + " " + (minite - 45));
        }
        }
    }
